...
from customer_page import customer_order_process, order_history_page, success_page, cancel_page
...
if not st.session_state["logged_in"]:
    ...
    if st.session_state["role"] == "Customer":
        page = st.sidebar.selectbox("Menu", ["Order Process", "Order History"])
        if page == "Order Process":
            customer_order_process()
        elif page == "Order History":
            st.write("Order History Page")
            order_history_page()
